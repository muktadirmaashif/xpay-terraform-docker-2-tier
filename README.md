...
| v2.0 | • Added another api container <br>• Added another database container (backup, replication)<br>• Binding volumes to back db container <br>• Isolated network for api and database containers | 🔄<br>🔄<br>🔄<br>🔄 |
